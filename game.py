...
class Game:
    ...
    def run( self ):
        ...
        agentIndex = self.startingIndex  #0
        numAgents = len( self.agents )  #1
        #print self.agents[agentIndex]
        #print('agentindex, numagents', self.startingIndex, numAgents)
